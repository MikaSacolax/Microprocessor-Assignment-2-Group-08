...
/**
 * @brief Handles waiting for an input from the Arm Assembly code and changes
 * the game state.
 *
 * @param context
 */
...
/**
 * @brief Handles the functions required to print the results, generate the next
 * challenge and changes the game state.
 *
 * @param context
 */
